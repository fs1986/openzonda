...
- Registrar la marca digital (verificado 02-08-2026: org GitHub 'openzonda' libre; sin paquete PyPI 'openzonda'; openzonda.org/.com/.dev/.io/.cl sin DNS — confirmar en el registrador antes de pagar): registrar openzonda.org (+.cl recomendado), proyecto Jira key OPENZONDA con tablero Kanban de 5 columnas. **Estado real**: el proyecto Jira existe (tarjetas OZ-N) y el repositorio vive en `github.com/fs1986/openzonda`, no bajo una organización dedicada. Crear la org sigue pendiente de decisión del fundador.
